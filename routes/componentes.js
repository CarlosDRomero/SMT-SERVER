...
componentesRouter.post("/catalogo", extraerUsuario, verificarRol(usuarioModel.roles.ADMIN),checkValidator, componenteController.crear)
componentesRouter.put("/catalogo/:idcomponente", extraerUsuario, verificarRol(usuarioModel.roles.ADMIN), UUIDParamValidator("idcomponente"),checkValidator, componenteController.actualizar)
